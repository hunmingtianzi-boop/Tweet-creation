...
- Give Hero and chapter headings an organization-specific display-type treatment when the visual route benefits from it. Use native, editable Ardot text for devices such as serif/sans contrast, controlled 1–4 px color misregistration, purposeful line breaks, oversized low-opacity chapter numerals, or restrained scale shifts. Keep the high-contrast title layer on top, leave body typography unchanged, and never rasterize or AI-generate Chinese display text.
